...
import org.apache.spark.ml.regression.spark333.{RandomForestRegressor => RandomForestRegressor333}
...
object RandomForestRegressorShim extends Logging {
  def create(uid: String): RandomForestRegressorShim = {
    ...
    val shim = Utils.getSparkVersion() match {
      case "3.1.1" | "3.1.2" | "3.1.3" | "3.2.0" | "3.2.1" | "3.2.2" | "3.3.3" =>
        new RandomForestRegressor333(uid)
