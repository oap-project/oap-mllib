...
import org.apache.spark.ml.classification.spark321.RandomForestClassifier
...
object RandomForestClassifierShim {
  def create(uid: String): RandomForestClassifierShim = {
    ...
    val shim = Utils.getSparkVersion() match {
      case "3.1.1" | "3.1.2" | "3.1.3" | "3.2.0" | "3.2.1" => new RandomForestClassifier(uid)
