...
public class HomogenNumericTable extends NumericTable {
  ...
  public HomogenNumericTable(DaalContext context, Class<? extends Number> cls, long nColumns) {
    ...
    tableImpl = new HomogenNumericTableByteBufferImpl(context, cls, nColumns,
        DataDictionary.FeaturesEqual.notEqual);
  }
   ...
   * @param nColumns Number of columns in the table
   */
  public HomogenNumericTable(DaalContext context, DataDictionary.FeaturesEqual featuresEqual,
   ...
   */
  public HomogenNumericTable(DaalContext context, Class<? extends Number> cls, long nColumns,
      long nRows, AllocationFlag allocFlag) {
    super(context);
  ...
  /**
   * Constructs homogeneous numeric table with memory allocation controlled via a flag and filling
   * the table with a constant
   *
   * @param context Context to manage created homogeneous numeric table
   * @param cls Numeric type of values in the table
   * @param nColumns Number of columns in the table
   ...
   */
  public HomogenNumericTable(DaalContext context, Class<? extends Number> cls, long nColumns,
      long nRows, AllocationFlag allocFlag, double constValue) {
    super(context);
    tableImpl = new HomogenNumericTableByteBufferImpl(context, cls, nColumns, nRows, allocFlag,
        constValue, DataDictionary.FeaturesEqual.notEqual);
  }
   ...
   */
  public HomogenNumericTable(DaalContext context, Class<? extends Number> cls, long nColumns,
      long nRows, AllocationFlag allocFlag, float constValue) {
    super(context);
    tableImpl = new HomogenNumericTableByteBufferImpl(context, cls, nColumns, nRows, allocFlag,
        constValue, DataDictionary.FeaturesEqual.notEqual);
  }
   ...
   */
  public HomogenNumericTable(DaalContext context, Class<? extends Number> cls, long nColumns,
      long nRows, AllocationFlag allocFlag, long constValue) {
    super(context);
    tableImpl = new HomogenNumericTableByteBufferImpl(context, cls, nColumns, nRows, allocFlag,
        constValue, DataDictionary.FeaturesEqual.notEqual);
  }
   ...
   */
  public HomogenNumericTable(DaalContext context, Class<? extends Number> cls, long nColumns,
      long nRows, AllocationFlag allocFlag, int constValue) {
    super(context);
    tableImpl = new HomogenNumericTableByteBufferImpl(context, cls, nColumns, nRows, allocFlag,
        constValue, DataDictionary.FeaturesEqual.notEqual);
  }
   ...
   */
  public HomogenNumericTable(DaalContext context, Class<? extends Number> cls,
      DataDictionary dict) {
    super(context);
