...
public abstract class NumericTable extends SerializableBase implements NumericTableDenseIface {
  ...
  public static class StorageLayout implements Serializable {
    ...
    public static final StorageLayout upperPackedSymmetricMatrix =
        new StorageLayout(_upperPackedSymmetricMatrix);
    public static final StorageLayout lowerPackedSymmetricMatrix =
        new StorageLayout(_lowerPackedSymmetricMatrix);
    public static final StorageLayout upperPackedTriangularMatrix =
        new StorageLayout(_upperPackedTriangularMatrix);
    public static final StorageLayout lowerPackedTriangularMatrix =
        new StorageLayout(_lowerPackedTriangularMatrix);
  ...
  public static class AllocationFlag {
    ...
    /**
     * @DAAL_DEPRECATED_USE{ @ref
     * com.intel.daal.data_management.data.NumericTable.AllocationFlag.DoNotAllocate "DoNotAllocate"
     * }
     */
  ...
  public static class NormalizationType {
    ...
    public static final NormalizationType standardScoreNormalized =
        new NormalizationType(_standardScoreNormalized);
