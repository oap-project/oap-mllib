 ...
 * @brief Contains classes that represent a dictionary of a data set and provide methods to work
 ...
 * @brief Class that represents the data set dictionary and provides methods to work with the data
 *        dictionary. Methods of the class use the com.intel.daal.data.DataFeature structure.
 */
public class DataDictionary extends SerializableBase {

  /** Specifies the status of memory related to the Numeric Table */
  public static class FeaturesEqual implements Serializable {
