...
public class CSRNumericTable extends NumericTable {
  ...
  protected long getSparseBlock(DataFeatureUtils.InternalNumType numType, long vectorIndex,
    ...
    return ((CSRNumericTableImpl) tableImpl).getSparseBlock(numType, vectorIndex, vectorNum, buf,
        colIndicesBuf, rowOffsetsBuf);
  }
  ...
  public DoubleBuffer getBlockOfColumnValues(long featureIndex, long vectorIndex, long vectorNum,
      DoubleBuffer buf) {
    return ((CSRNumericTableImpl) tableImpl).getBlockOfColumnValues(featureIndex, vectorIndex,
        vectorNum, buf);
  }
  ...
  public void releaseBlockOfColumnValues(long featureIndex, long vectorIndex, long vectorNum,
      DoubleBuffer buf) {
    ((CSRNumericTableImpl) tableImpl).releaseBlockOfColumnValues(featureIndex, vectorIndex,
        vectorNum, buf);
  }
  ...
  protected long getDoubleSparseBlock(long vectorIndex, long vectorNum, ByteBuffer buf,
    ...
    return ((CSRNumericTableImpl) tableImpl).getDoubleSparseBlock(vectorIndex, vectorNum, buf,
        colIndicesBuf, rowOffsetsBuf);
  ...
  protected long getFloatSparseBlock(long vectorIndex, long vectorNum, ByteBuffer buf,
      ByteBuffer colIndicesBuf, ByteBuffer rowOffsetsBuf) {
    return ((CSRNumericTableImpl) tableImpl).getFloatSparseBlock(vectorIndex, vectorNum, buf,
        colIndicesBuf, rowOffsetsBuf);
  }

  protected long getIntSparseBlock(long vectorIndex, long vectorNum, ByteBuffer buf,
      ByteBuffer colIndicesBuf, ByteBuffer rowOffsetsBuf) {
    return ((CSRNumericTableImpl) tableImpl).getIntSparseBlock(vectorIndex, vectorNum, buf,
        colIndicesBuf, rowOffsetsBuf);
  }
}
/** @} */
