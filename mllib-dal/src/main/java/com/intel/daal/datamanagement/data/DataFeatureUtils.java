 ...
 */
package com.intel.daal.datamanagement.data;
...
public class DataFeatureUtils {
  ...
  /**
   * Internal data type representing feature value in methods of the NumericTable class
   */
  public enum IndexNumType {
    DAAL_FLOAT32(cDaalFloat32), DAAL_FLOAT64(cDaalFloat64), DAAL_INT32_S(cDaalInt32S), DAAL_INT32_U(
        cDaalInt32U), DAAL_INT64_S(
            cDaalInt64S), DAAL_INT64_U(cDaalInt64U), DAAL_OTHER_T(cDaalOtherT);
  ...
  public enum InternalNumType {
    DAAL_SINGLE(cDaalSingle), DAAL_DOUBLE(cDaalDouble), DAAL_INT32(cDaalInt32), DAAL_OTHER(
        cDaalOther);
  ...
  static Class<?> getClassByType(InternalNumType numType) {
    if (numType == InternalNumType.DAAL_SINGLE) {
      return float.class;
    } else if (numType == InternalNumType.DAAL_DOUBLE) {
      return double.class;
    } else if (numType == InternalNumType.DAAL_INT32) {
      return int.class;
    } else {
      return null;
    }
  ...
  public enum PMMLNumType {
    DAAL_GEN_FLOAT(cDaalGenFloat), DAAL_GEN_DOUBLE(cDaalGenDouble), DAAL_GEN_INTEGER(
        cDaalGenInteger), DAAL_GEN_BOOLEAN(
            cDaalGenBoolean), DAAL_GEN_STRING(cDaalGenString), DAAL_GEN_UNKNOWN(cDaalGenUnknown);
  ...
  public enum FeatureType {
    DAAL_CATEGORICAL(cDaalCategorical), DAAL_ORDINAL(cDaalOrdinal), DAAL_CONTINUOUS(
        cDaalContinuous);
  ...
  interface VectorUpCastIface {
    /**
     * Casts contiguous block of data from the array of primitive types to the NIO buffer
     *
     * @param n Number of elements to copy from the array to the NIO buffer
     * @param shift Index of the starting element to copy from the array to the NIO buffer
    ...
    /**
     * Casts non-contiguous block of data from the array of primitive types to the NIO buffer
     *
     * @param n Number of elements to copy from the array to the NIO buffer
     ...
     * @param dst Resulting NIO buffer
     */
    void upCastWithBufferStride(int n, int dataShift, int bufferShift, int bufferStep, Object src,
        Buffer dst);

    /**
     * Casts non-contiguous block of data from the array of primitive types to the NIO buffer with
     * stride
     *
     * @param n Number of elements to copy from the array into NIO buffer
     * @param dataShift Index of the starting element in input array
     ...
     * @param dst Resulting NIO buffer
     */
    void upCastWithBothStrides(int n, int dataShift, int bufferShift, int dataStep, int bufferStep,
  ...
  interface VectorDownCastIface {
    /**
     * Casts continuous block of data from the NIO buffer to the array of primitive types
     *
    ...
    /**
     * Casts non-contiguous block of data from the NIO buffer to the array of primitive types
     *
     * @param n Number of elements to copy from the NIO buffer into array
     * @param shift Index of the starting element to copy
    ...
    /**
     * Casts non-contiguous block of data from the NIO buffer to the continuous array of primitive
     * types
     *
     ...
     * @param dst Resulting array of primitive types
     */
    void downCastWithBufferStride(int n, int dataShift, int bufferShift, int bufferStep, Buffer src,
        Object dst);
     ...
     * @param dst Resulting array of primitive types
     */
    void downCastWithBothStrides(int n, int dataShift, int bufferShift, int dataStep,
        int bufferStep, Buffer src, Object dst);
  }

  /** @private */
  abstract static class VectorUpCastBase implements VectorUpCastIface, Serializable {
    @Override
    ...
    @Override
    public void upCastWithBufferStride(int n, int dataShift, int bufferShift, int bufferStep,
        Object src, Buffer dst) {
  ...
  /** @private */
  abstract static class VectorDownCastBase implements VectorDownCastIface, Serializable {
    @Override
    ...
    @Override
    public void downCastWithBufferStride(int n, int dataShift, int bufferShift, int bufferStep,
  ...
  /** @private */
  abstract static class VectorUpCastBase2Types extends VectorUpCastBase {
    @Override
  ...
  /** @private */
  abstract static class VectorDownCastBase2Types extends VectorDownCastBase {
    @Override
  ...
  static class VectorUpCast {
    public static VectorUpCastIface getCast(Class<?> fromCls, Class<?> toCls) {
  ...
  static class VectorDownCast {
    public static VectorDownCastIface getCast(Class<?> fromCls, Class<?> toCls) {
  ...
  static class VectorUpCastDouble2Double extends VectorUpCastBase {
    ...
    @Override
    public void upCastWithBothStrides(int n, int dataShift, int bufferShift, int dataStep,
        int bufferStep, Object src, Buffer dst) {
  ...
  static class VectorDownCastDouble2Double extends VectorDownCastBase {
    ...
    @Override
    public void downCastWithBothStrides(int n, int dataShift, int bufferShift, int dataStep,
        int bufferStep, Buffer src, Object dst) {
      double[] data = (double[]) dst;
      for (int i = 0; i < n; i++) {
  ...
  static class VectorUpCastDouble2Float extends VectorUpCastBase2Types {
    ...
    public void upCastWithBothStrides(int n, int dataShift, int bufferShift, int dataStep,
      ...
      double[] data = (double[]) src;
      for (int i = 0; i < n; i++) {
        ((FloatBuffer) dst).put(bufferShift + i * bufferStep,
            (float) (data[dataShift + i * dataStep]));
      }
    }
  }
  ...
  static class VectorDownCastDouble2Float extends VectorDownCastBase2Types {
    ...
    public void downCastWithBothStrides(int n, int dataShift, int bufferShift, int dataStep,
      ...
      for (int i = 0; i < n; i++) {
        data[dataShift + i * dataStep] =
            (float) (((DoubleBuffer) src).get(bufferShift + i * bufferStep));
      }
    }
  }
  ...
  static class VectorDownCastDouble2Int extends VectorDownCastBase2Types {
    ...
    public void downCastWithBothStrides(int n, int dataShift, int bufferShift, int dataStep,
      ...
      for (int i = 0; i < n; i++) {
        data[dataShift + i * dataStep] =
            (int) (((DoubleBuffer) src).get(bufferShift + i * bufferStep));
      }
    }
  }
  ...
  static class VectorDownCastFloat2Int extends VectorDownCastBase2Types {
    ...
    public void downCastWithBothStrides(int n, int dataShift, int bufferShift, int dataStep,
      ...
      for (int i = 0; i < n; i++) {
        data[dataShift + i * dataStep] =
            (int) (((FloatBuffer) src).get(bufferShift + i * bufferStep));
      }
    }
  }
  ...
  static class VectorDownCastDouble2Long extends VectorDownCastBase2Types {
    ...
    public void downCastWithBothStrides(int n, int dataShift, int bufferShift, int dataStep,
      ...
      for (int i = 0; i < n; i++) {
        data[dataShift + i * dataStep] =
            (long) (((DoubleBuffer) src).get(bufferShift + i * bufferStep));
      }
    }
  }
  ...
  static class VectorDownCastFloat2Long extends VectorDownCastBase2Types {
    ...
    public void downCastWithBothStrides(int n, int dataShift, int bufferShift, int dataStep,
      ...
      for (int i = 0; i < n; i++) {
        data[dataShift + i * dataStep] =
            (long) (((FloatBuffer) src).get(bufferShift + i * bufferStep));
      }
    }
  }
  ...
  static VectorUpCastIface[][] vectorUpCasts = {
      {(VectorUpCastIface) (new VectorUpCastFloat2Float()),
          (VectorUpCastIface) (new VectorUpCastFloat2Double()),
          (VectorUpCastIface) (new VectorUpCastFloat2Int())},
      {(VectorUpCastIface) (new VectorUpCastDouble2Float()),
          (VectorUpCastIface) (new VectorUpCastDouble2Double()),
          (VectorUpCastIface) (new VectorUpCastDouble2Int())},
      {(VectorUpCastIface) (new VectorUpCastInt2Float()),
          (VectorUpCastIface) (new VectorUpCastInt2Double()),
          (VectorUpCastIface) (new VectorUpCastInt2Int())},
      {(VectorUpCastIface) (new VectorUpCastLong2Float()),
          (VectorUpCastIface) (new VectorUpCastLong2Double()),
          (VectorUpCastIface) (new VectorUpCastLong2Int())}};

  static VectorDownCastIface[][] vectorDownCasts = {
      {(VectorDownCastIface) (new VectorDownCastFloat2Float()),
          (VectorDownCastIface) (new VectorDownCastFloat2Double()),
          (VectorDownCastIface) (new VectorDownCastFloat2Int()),
          (VectorDownCastIface) (new VectorDownCastFloat2Long())},
      {(VectorDownCastIface) (new VectorDownCastDouble2Float()),
          (VectorDownCastIface) (new VectorDownCastDouble2Double()),
          (VectorDownCastIface) (new VectorDownCastDouble2Int()),
          (VectorDownCastIface) (new VectorDownCastDouble2Long())},
      {(VectorDownCastIface) (new VectorDownCastInt2Float()),
          (VectorDownCastIface) (new VectorDownCastInt2Double()),
          (VectorDownCastIface) (new VectorDownCastInt2Int()),
          (VectorDownCastIface) (new VectorDownCastInt2Long())},};
}
/** @} */
