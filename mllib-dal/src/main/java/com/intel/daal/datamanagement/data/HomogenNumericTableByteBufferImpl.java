...
/**
 * <a name=
 * "DAAL-CLASS-DATA__HOMOGENNUMERICTABLEBYTEBUFFERIMPL__HOMOGENNUMERICTABLEBYTEBUFFERIMPL"></a>
 * @brief A derivative class of the HomogenNumericTableImpl class, that provides implementation of a
 *        homogen numeric table with data stored in a native C++ numeric table
 */
public class HomogenNumericTableByteBufferImpl extends HomogenNumericTableImpl {
  ...
  /**
   * @copydoc HomogenNumericTable::HomogenNumericTable(DaalContext,Class<? extends
   *          Number>,long,DataDictionary.FeaturesEqual)
   */
  public HomogenNumericTableByteBufferImpl(DaalContext context, Class<? extends Number> cls,
      long nColumns, DataDictionary.FeaturesEqual featuresEqual) {
    super(context);
    initHomogenNumericTable(context, cls, nColumns, 0, NumericTable.AllocationFlag.DoNotAllocate,
        featuresEqual);
  }

  /**
   * @copydoc HomogenNumericTable::HomogenNumericTable(DaalContext,Class<? extends
   *          Number>,long,long,NumericTable.AllocationFlag,DataDictionary.FeaturesEqual)
   */
  public HomogenNumericTableByteBufferImpl(DaalContext context, Class<? extends Number> cls,
      long nColumns, long nRows, NumericTable.AllocationFlag allocFlag,
  ...
  /**
   * @copydoc HomogenNumericTable::HomogenNumericTable(DaalContext,Class<? extends
   *          Number>,long,long,NumericTable.AllocationFlag,double,DataDictionary.FeaturesEqual)
   */
  public HomogenNumericTableByteBufferImpl(DaalContext context, Class<? extends Number> cls,
      long nColumns, long nRows, NumericTable.AllocationFlag allocFlag, double constValue,
      DataDictionary.FeaturesEqual featuresEqual) {
    super(context);
    initHomogenNumericTable(context, cls, nColumns, nRows, allocFlag, featuresEqual);
  ...
  /**
   * @copydoc HomogenNumericTable::HomogenNumericTable(DaalContext,Class<? extends
   *          Number>,long,long,NumericTable.AllocationFlag,float,DataDictionary.FeaturesEqual)
   */
  public HomogenNumericTableByteBufferImpl(DaalContext context, Class<? extends Number> cls,
      long nColumns, long nRows, NumericTable.AllocationFlag allocFlag, float constValue,
      DataDictionary.FeaturesEqual featuresEqual) {
    super(context);
    initHomogenNumericTable(context, cls, nColumns, nRows, allocFlag, featuresEqual);
    if (allocFlag.ordinal() == NumericTable.AllocationFlag.DoAllocate.ordinal()) {
  ...
  /**
   * @copydoc HomogenNumericTable::HomogenNumericTable(DaalContext,Class<? extends
   *          Number>,long,long,NumericTable.AllocationFlag,long,DataDictionary.FeaturesEqual)
   */
  public HomogenNumericTableByteBufferImpl(DaalContext context, Class<? extends Number> cls,
      long nColumns, long nRows, NumericTable.AllocationFlag allocFlag, long constValue,
      DataDictionary.FeaturesEqual featuresEqual) {
    super(context);
    initHomogenNumericTable(context, cls, nColumns, nRows, allocFlag, featuresEqual);
    if (allocFlag.ordinal() == NumericTable.AllocationFlag.DoAllocate.ordinal()) {
  ...
  /**
   * @copydoc HomogenNumericTable::HomogenNumericTable(DaalContext,Class<? extends
   *          Number>,long,long,NumericTable.AllocationFlag,int,DataDictionary.FeaturesEqual)
   */
  public HomogenNumericTableByteBufferImpl(DaalContext context, Class<? extends Number> cls,
      long nColumns, long nRows, NumericTable.AllocationFlag allocFlag, int constValue,
      DataDictionary.FeaturesEqual featuresEqual) {
    super(context);
    initHomogenNumericTable(context, cls, nColumns, nRows, allocFlag, featuresEqual);
    if (allocFlag.ordinal() == NumericTable.AllocationFlag.DoAllocate.ordinal()) {
  ...
  public DoubleBuffer getBlockOfColumnValues(long featureIndex, long vectorIndex, long vectorNum,
    ...
    if (bufferSize * 8 > maxBufferSize) {
      throw new IllegalArgumentException(
          "size of the block of column values cannot exceed 2 gigabytes");
    }
    ByteBuffer byteBuf = ByteBuffer.allocateDirect((int) (bufferSize * 8) /* sizeof(double) */);
    byteBuf.order(ByteOrder.LITTLE_ENDIAN);
  ...
  private void initHomogenNumericTable(DaalContext context, Class<? extends Number> cls,
      long nColumns, long nRows, NumericTable.AllocationFlag allocFlag,
      DataDictionary.FeaturesEqual featuresEqual) {
    if (cls == Double.class) {
  ...
  private native ByteBuffer getDoubleBlockBuffer(long cObject, long vectorIndex, long vectorNum,
      ByteBuffer buffer);

  private native ByteBuffer getFloatBlockBuffer(long cObject, long vectorIndex, long vectorNum,
      ByteBuffer buffer);

  private native ByteBuffer getIntBlockBuffer(long cObject, long vectorIndex, long vectorNum,
      ByteBuffer buffer);

  private native void releaseDoubleBlockBuffer(long cObject, long vectorIndex, long vectorNum,
      ByteBuffer buffer);

  private native void releaseFloatBlockBuffer(long cObject, long vectorIndex, long vectorNum,
      ByteBuffer buffer);

  private native void releaseIntBlockBuffer(long cObject, long vectorIndex, long vectorNum,
      ByteBuffer buffer);
  ...
  private native ByteBuffer getDoubleColumnBuffer(long cObject, long featureIndex, long vectorIndex,
      long vectorNum, ByteBuffer buffer);

  private native ByteBuffer getFloatColumnBuffer(long cObject, long featureIndex, long vectorIndex,
      long vectorNum, ByteBuffer buffer);

  private native ByteBuffer getIntColumnBuffer(long cObject, long featureIndex, long vectorIndex,
      long vectorNum, ByteBuffer buffer);

  private native void releaseDoubleColumnBuffer(long cObject, long featureIndex, long vectorIndex,
      long vectorNum, ByteBuffer buffer);

  private native void releaseFloatColumnBuffer(long cObject, long featureIndex, long vectorIndex,
      long vectorNum, ByteBuffer buffer);

  private native void releaseIntColumnBuffer(long cObject, long featureIndex, long vectorIndex,
      long vectorNum, ByteBuffer buffer);
