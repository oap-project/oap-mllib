...
/*
 * Class:     com_intel_daal_datamanagement_data_SerializableBase
 * Method:    cSerializeCObject
 * Signature: (J)Ljava/nio/ByteBuffer;
 */
JNIEXPORT jobjectArray JNICALL Java_com_intel_daal_datamanagement_data_SerializableBase_cSerializeCObject(JNIEnv * env, jobject thisObj, jlong ptr)
{
 ...
 */
JNIEXPORT jlong JNICALL Java_com_intel_daal_datamanagement_data_SerializableBase_cDeserializeCObject(JNIEnv * env, jobject thisObj,
 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_com_intel_daal_datamanagement_data_SerializableBase_cDispose(JNIEnv * env, jobject thisObj, jlong ptr)
{
    delete (SerializationIfacePtr *)ptr;
}

JNIEXPORT void JNICALL Java_com_intel_daal_datamanagement_data_SerializableBase_throwUnpacked(JNIEnv * env, jobject thisObj)
{
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_com_intel_daal_datamanagement_data_SerializableBase_cSetJavaVM(JNIEnv * env, jobject thisObj)
{
    JavaVM * jvm;
 ...
 */
JNIEXPORT void JNICALL Java_com_intel_daal_datamanagement_data_SerializableBase_cSetDaalContext(JNIEnv * env, jobject thisObj, jobject context)
{
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_com_intel_daal_datamanagement_data_SerializableBase_cClearDaalContext(JNIEnv * env, jobject thisObj)
{
