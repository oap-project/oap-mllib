...
if [ ! -d /opt/intel/oneapi ]; then
  ...
  sudo apt update
  sudo apt-get install -y intel-basekit-getting-started intel-oneapi-advisor intel-oneapi-ccl-2021.8.0 intel-oneapi-ccl-devel-2021.8.0 intel-oneapi-common-licensing-2023.0.0  \
